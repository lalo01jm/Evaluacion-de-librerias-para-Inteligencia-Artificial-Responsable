...
> [!IMPORTANT]
> Este repositorio tiene fines educativos. Sus resultados no deben utilizarse para
> tomar decisiones reales sobre personas ni interpretarse como una validación del
> sistema COMPAS.
...
├── 2.Entrenamiento_Modelos.ipynb
├── 3.Auditoria (Aequitas).ipynb
├── Tutorial/
│   ├── Tutorial.ipynb
│   ├── preprocessing.py
│   ├── train_model.py
...
Se recomienda Python 3.11 y un entorno virtual independiente.
...
- La elección de atributos sensibles, grupos de referencia y umbrales afecta las
  conclusiones.
- Este proyecto compara herramientas mediante un ejemplo educativo; no pretende
  certificar modelos ni organizaciones.

## Estado del proyecto

El repositorio se encuentra en desarrollo. La siguiente etapa estructural será
separar formalmente la lógica reutilizable (`src/`), los notebooks explicativos,
las pruebas y la documentación metodológica.

## Licencia

El proyecto todavía no declara una licencia de reutilización. Hasta que se añada
una, se conservan todos los derechos que correspondan al autor. La licencia de
los datos y de cualquier material derivado debe documentarse por separado.
